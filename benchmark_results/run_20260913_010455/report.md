...
**Run ID:** `run_20260913_010455` | **Date:** 2026-09-13 01:04:57 | **Software Version:** 1.0.0
...
| **Mean Execution Latency** | 278.1 ms | Average pipeline runtime per query |
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| `synth_change_01` | `change_detection` | 0.250 | 0.250 | 1.000 | 1639ms | ✅ | `none` |
| `synth_bldg_01` | `building_segmentation` | 0.000 | 0.000 | 0.000 | 5ms | ✅ | `segmentation_failure` |
| `synth_flood_01` | `flood_segmentation` | 0.299 | 0.299 | 1.000 | 9ms | ❌ | `none` |
| `synth_cap_rgb_ndvi_01` | `capability_enforcement` | — | — | — | 2ms | ❌ | `none` |
| `synth_cap_single_change_01` | `capability_enforcement` | — | — | — | 7ms | ✅ | `unsupported_capability` |
| `synth_verif_bounds_01` | `verification` | — | — | — | 7ms | ✅ | `none` |
